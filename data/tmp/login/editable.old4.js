...
function addImage(ID,pos){
  ...
  if(typeof(imgadded)=="undefined"){
    ...
    imgadded.css("height","auto");   // added as these were bein set to 30x300
...
$(".reissued").css({"border":"1px solid","border-color":"red"});
$(".info").css({"border":"1px solid","border-color":"blue"});
$(".CanNotDelete").css({"border":"1px solid","border-color":"pink","padding":"2px","margin":"2px"});
