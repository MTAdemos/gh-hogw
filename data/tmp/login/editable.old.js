...
function add_imageuploadformstr(ID){
...
//          if($(this).attr("src").indexOf("-className-")>-1){
//            str_arr=$(this).attr("src").split("-className-");
//            $(this).attr("src",str_arr[0]);
//            if(str_arr[1].indexOf("center")>-1){
//              $(this).wrap("<div class=imgcenter />");
//              }
//            else{
//              $(this).addClass(str_arr[1]);
//            }
//          }
//        });
      }
...
ComposerSelectionStr+="  <option value='composerA'>composerA</option>\n";
ComposerSelectionStr+="  <option value='composerB'>composerB</option>\n";
ComposerSelectionStr+="  <option value='composerC'>composerC</option>\n";
ComposerSelectionStr+="  <option value='composerD'>composerD</option>\n";
ComposerSelectionStr+="  <option value='composerE'>composerE</option>\n";
ComposerSelectionStr+="  <option value='composerF'>composerF</option>\n";
ComposerSelectionStr+="  <option value='composerG'>composerG</option>\n";
ComposerSelectionStr+="  <option value='composerH'>composerH</option>\n";
ComposerSelectionStr+="  <option value='composerI'>composerI</option>\n";
ComposerSelectionStr+="  <option value='composerJ'>composerJ</option>\n";
ComposerSelectionStr+="  <option value='composerK'>composerK</option>\n";
ComposerSelectionStr+="  <option value='composerL'>composerL</option>\n";
ComposerSelectionStr+="  <option value='composerM'>composerM</option>\n";
ComposerSelectionStr+="  <option value='composerN'>composerN</option>\n";
ComposerSelectionStr+="  <option value='composerO'>composerO</option>\n";
ComposerSelectionStr+="  <option value='composerP'>composerP</option>\n";
ComposerSelectionStr+="  <option value='composerQ'>composerQ</option>\n";
ComposerSelectionStr+="  <option value='composerR'>composerR</option>\n";
ComposerSelectionStr+="  <option value='composerS'>composerS</option>\n";
ComposerSelectionStr+="  <option value='composerT'>composerT</option>\n";
ComposerSelectionStr+="  <option value='composerU'>composerU</option>\n";
ComposerSelectionStr+="  <option value='composerV'>composerV</option>\n";
ComposerSelectionStr+="  <option value='composerW'>composerW</option>\n";
ComposerSelectionStr+="  <option value='composerX'>composerX</option>\n";
ComposerSelectionStr+="  <option value='composerY'>composerY</option>\n";
ComposerSelectionStr+="  <option value='composerZ' class=sepccomp>composerZ</option>\n";
ComposerSelectionStr+="  <option value='bach' class=sepccomp>bach</option>\n";
ComposerSelectionStr+="  <option value='beethoven' class=sepccomp>beethoven</option>\n";
ComposerSelectionStr+="  <option value='handel' class=sepccomp>handel</option>\n";
ComposerSelectionStr+="  <option value='haydn' class=sepccomp>haydn</option>\n";
ComposerSelectionStr+="  <option value='martinu' class=sepccomp>martinu</option>\n";
ComposerSelectionStr+="  <option value='mozart' class=sepccomp>mozart</option>\n";
ComposerSelectionStr+="  <option value='purcell' class=sepccomp>purcell</option>\n";
ComposerSelectionStr+="  <option value='vivaldi' class=sepccomp>vivaldi</option>\n";
...
ComposerSelectionStr+="<select>\n";
ComposerSelectionStr+="  <option value='instrumental'>instrumental</option>\n";
ComposerSelectionStr+="  <option value='sacredvocal'>sacredvocal</option>\n";
ComposerSelectionStr+="  <option value='secularvocal'>secularvocal</option>\n";
ComposerSelectionStr+="  <option value='symphonies'>symphonies</option>\n";
ComposerSelectionStr+="</select>\n";
...
jQuery.fn.extend({
  EnableComposerLabelEditing: function(){
    ...
    for(var i=0;i<classes.length;i++){
      if(classes[i].indexOf("composer")==0)composerlabel=classes[i];
    }
    if(composerlabel=="unset"){
      if(classesStr.indexOf("haydn")>-1)composerlabel="haydn";
      if(classesStr.indexOf("mozart")>-1)composerlabel="mozart";
      if(classesStr.indexOf("bach")>-1)composerlabel="bach";
      if(classesStr.indexOf("beethoven")>-1)composerlabel="beethoven";
      if(classesStr.indexOf("handel")>-1)composerlabel="handel";
      if(classesStr.indexOf("haydn")>-1)composerlabel="haydn";
      if(classesStr.indexOf("martinu")>-1)composerlabel="martinu";
      if(classesStr.indexOf("mozart")>-1)composerlabel="mozart";
      if(classesStr.indexOf("purcell")>-1)composerlabel="purcell";
      if(classesStr.indexOf("vivaldi")>-1)composerlabel="vivaldi";
    }
   $(this).prepend(ComposerSelectionStr);
   $(".composerselectcat").hide();
   //show the selection category if it is a named composer
   $("#composerselectdropdown").on("change",function(){
     if($('#composerselectdropdown').val().indexOf("composer")>-1){
       $(".composerselectcat").hide();      
       }
     else{
...
console.log("composerlabel: " + composerlabel + " if " + (composerlabel!="unset"));
   if(composerlabel!="unset")$('#composerselectdropdown').val(composerlabel);          
  }
});
...
function generate_imageborderstr(){
  ...
  imgbordertogglestr+="</form></div>";
  return imgbordertogglestr;
}

function Add_click_handler(imgchanging){
  imgchanging.next().find("input").change(function(){
...
jQuery.fn.extend({
  edit: function(){
    ...
    $(this).find("img").each(function(){
      ...
      // install event handler for click
