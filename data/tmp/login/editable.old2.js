...
// remove composer and section classs and add composer on the basis of what is here
...
// save and restore selection of category

   var IndexSelected=-1;
   for(var i=0;i<ComposerSelectionArr.length;i++){
     if(ComposerSelectionArr[i]==composerlabel)IndexSelected=i;
   }
console.log($("#composerselectdropdown").html());
console.log("IndexSelected: " + IndexSelected);
   if(IndexSelected>-1){$('#composerselectdropdown').prop("selectedIndex",IndexSelected);}
  }
});
